...
.. codeblock:: bash
    ...
    # Set this variable
    EXPATH=/path/to/your/edflow/examples/

    cd $EXPATH
    edflow -n py_example -t python_only/config.yaml
"""
...
class Model(object):
    def __init__(self, config):
        ...
        self.q_type = config.get("queue_type", "fifo")
        self.m_size = config.get("mem_size", -1)
